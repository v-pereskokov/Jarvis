...
public:
    ...
    void setupUi(QDialog *SettingsDialogWindow)
    {
        ...
        verticalLayout_2 = new QVBoxLayout(SettingsDialogWindow);
        ...
        gridLayout->addLayout(vertNameLabelsLayout, 1, 0, 3, 1);
...
"color: #00FBF6;"));
        ...
        buttonBox = new QDialogButtonBox(SettingsDialogWindow);
