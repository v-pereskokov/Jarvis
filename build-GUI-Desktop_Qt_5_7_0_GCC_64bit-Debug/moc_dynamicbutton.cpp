...
#include "../../Jarvis-GUI/GUI/GUI/dynamicbutton.h"
...
const QMetaObject DynamicButton::staticMetaObject = {
    { &SmartBulb::staticMetaObject, qt_meta_stringdata_DynamicButton.data,
      qt_meta_data_DynamicButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
