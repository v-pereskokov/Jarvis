...
#ifndef PROTOBUF_ConnectionResponse_2eproto__INCLUDED
#define PROTOBUF_ConnectionResponse_2eproto__INCLUDED
...
class ConnectionResponse : public ::google::protobuf::Message {
 public:
  ...
  inline ::ConnectionResponse_ResponseCode responsecode() const;
  inline void set_responsecode(::ConnectionResponse_ResponseCode value);
 ...
 private:
  ...
  ::std::string* message_;
  int responsecode_;
  friend void  protobuf_AddDesc_ConnectionResponse_2eproto();
  friend void protobuf_AssignDesc_ConnectionResponse_2eproto();
  friend void protobuf_ShutdownFile_ConnectionResponse_2eproto();
...
#endif  // PROTOBUF_ConnectionResponse_2eproto__INCLUDED
